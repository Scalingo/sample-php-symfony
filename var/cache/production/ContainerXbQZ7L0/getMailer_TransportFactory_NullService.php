 ...
 */
class getMailer_TransportFactory_NullService extends App_KernelProductionDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Mailer\Transport\NullTransportFactory($a, ($container->privates['http_client.uri_template'] ?? $container->load('getHttpClient_UriTemplateService')), ($container->privates['monolog.logger.mailer'] ??= new \Monolog\Logger('mailer')));
