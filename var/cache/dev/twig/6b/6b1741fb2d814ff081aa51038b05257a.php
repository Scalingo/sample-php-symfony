...
class __TwigTemplate_0edc0ee02171abeee45a7d65cccaa009 extends Template
{
            ...
            if (window.XMLHttpRequest && XMLHttpRequest.prototype.addEventListener) {
                ...
                XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
                    ...
                    if (url.slice(0, 1) === '/') {
                        if (0 === url.indexOf('";
            // line 405
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 405), "js"), "html", null, true);
            yield "')) {
                            path = url.slice(";
            // line 406
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 406)), "html", null, true);
            yield ");
                        }
                    }
                    else if (0 === url.indexOf('";
            // line 409
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, false, 409) . CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 409)), "js"), "html", null, true);
            yield "')) {
                        path = url.slice(";
            // line 410
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), (CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, false, 410) . CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 410))), "html", null, true);
            yield ");
                    }
...
";
    ...
    {
        return array (  768 => 675,  736 => 646,  645 => 558,  527 => 442,  495 => 413,  489 => 410,  485 => 409,  479 => 406,  475 => 405,  429 => 362,  366 => 302,  360 => 298,  358 => 297,  71 => 18,  60 => 13,  55 => 10,  53 => 8,  52 => 3,  48 => 2,  45 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@WebProfiler/Profiler/toolbar_js.html.twig", "/Users/samir/Desktop/Scalingo/sample/sample-php-symfony/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/toolbar_js.html.twig");
    }
}
